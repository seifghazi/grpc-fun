...
var file_api_proto_rawDesc = []byte{
	...
	0x28, 0x09, 0x52, 0x07, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x32, 0xaa, 0x02, 0x0a, 0x0b,
	...
	0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x22, 0x00, 0x12, 0x39, 0x0a, 0x13, 0x45, 0x73, 0x74,
	0x61, 0x62, 0x6c, 0x69, 0x73, 0x68, 0x43, 0x6f, 0x6e, 0x6e, 0x65, 0x63, 0x74, 0x69, 0x6f, 0x6e,
	...
	,
...
var file_api_proto_depIdxs = []int32{
	...
	0, // 1: proto.SendMessage.EstablishConnection:input_type -> proto.Message
	0, // 2: proto.SendMessage.ServerStreamHello:input_type -> proto.Message
	0, // 3: proto.SendMessage.ClientStreamHello:input_type -> proto.Message
	0, // 4: proto.SendMessage.BiDricetionalStreamHello:input_type -> proto.Message
	0, // 5: proto.SendMessage.SayHello:output_type -> proto.Message
	0, // 6: proto.SendMessage.EstablishConnection:output_type -> proto.Message
	0, // 7: proto.SendMessage.ServerStreamHello:output_type -> proto.Message
	0, // 8: proto.SendMessage.ClientStreamHello:output_type -> proto.Message
	0, // 9: proto.SendMessage.BiDricetionalStreamHello:output_type -> proto.Message
...
type SendMessageClient interface {
	...
	EstablishConnection(ctx context.Context, in *Message, opts ...grpc.CallOption) (SendMessage_EstablishConnectionClient, error)
...
func (c *sendMessageClient) EstablishConnection(ctx context.Context, in *Message, opts ...grpc.CallOption) (SendMessage_EstablishConnectionClient, error) {
	stream, err := c.cc.NewStream(ctx, &_SendMessage_serviceDesc.Streams[0], "/proto.SendMessage/EstablishConnection", opts...)
	if err != nil {
		return nil, err
	}
	x := &sendMessageEstablishConnectionClient{stream}
...
type SendMessage_EstablishConnectionClient interface {
	Recv() (*Message, error)
	grpc.ClientStream
}

type sendMessageEstablishConnectionClient struct {
	grpc.ClientStream
}

func (x *sendMessageEstablishConnectionClient) Recv() (*Message, error) {
	m := new(Message)
...
func (c *sendMessageClient) ServerStreamHello(ctx context.Context, in *Message, opts ...grpc.CallOption) (SendMessage_ServerStreamHelloClient, error) {
	stream, err := c.cc.NewStream(ctx, &_SendMessage_serviceDesc.Streams[1], "/proto.SendMessage/ServerStreamHello", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *sendMessageClient) ClientStreamHello(ctx context.Context, opts ...grpc.CallOption) (SendMessage_ClientStreamHelloClient, error) {
	stream, err := c.cc.NewStream(ctx, &_SendMessage_serviceDesc.Streams[2], "/proto.SendMessage/ClientStreamHello", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *sendMessageClient) BiDricetionalStreamHello(ctx context.Context, opts ...grpc.CallOption) (SendMessage_BiDricetionalStreamHelloClient, error) {
	stream, err := c.cc.NewStream(ctx, &_SendMessage_serviceDesc.Streams[3], "/proto.SendMessage/BiDricetionalStreamHello", opts...)
	if err != nil {
		return nil, err
	}
...
type SendMessageServer interface {
	...
	EstablishConnection(*Message, SendMessage_EstablishConnectionServer) error
...
func (*UnimplementedSendMessageServer) EstablishConnection(*Message, SendMessage_EstablishConnectionServer) error {
...
func _SendMessage_EstablishConnection_Handler(srv interface{}, stream grpc.ServerStream) error {
	m := new(Message)
	if err := stream.RecvMsg(m); err != nil {
		return err
	}
	return srv.(SendMessageServer).EstablishConnection(m, &sendMessageEstablishConnectionServer{stream})
}

type SendMessage_EstablishConnectionServer interface {
	Send(*Message) error
	grpc.ServerStream
}

type sendMessageEstablishConnectionServer struct {
	grpc.ServerStream
}

func (x *sendMessageEstablishConnectionServer) Send(m *Message) error {
	...
	Streams: []grpc.StreamDesc{
		{
			...
			Handler:       _SendMessage_EstablishConnection_Handler,
			ServerStreams: true,
		},
		{
